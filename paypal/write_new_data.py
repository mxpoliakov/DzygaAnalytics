...
def get_last_document_datetime(donation_source):
...
def get_paypal_api_data(access_token, last_document_datetime):
    ...
    for transaction in response["transaction_details"][1:]:
            ...
            rows.append(
                {
                    ...
                    "From Email Address": payer_info["email_address"],
                    "Net": convert_currency(net, currency, transaction_dt),
                    "Gross": net,
                    "Currency": currency,
